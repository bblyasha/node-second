...
import { addExtensionMethods as addExtensionMethodsT, Apollo, BrowserTracing as BrowserTracingT, Express, getActiveTransaction as getActiveTransactionT, GraphQL, hasTracingEnabled as hasTracingEnabledT, IdleTransaction as IdleTransactionT, instrumentOutgoingRequests as instrumentOutgoingRequestsT, Mongo, Mysql, Postgres, Prisma, Span as SpanT, SpanStatus as SpanStatusT, spanStatusfromHttpCode as spanStatusfromHttpCodeT, startIdleTransaction as startIdleTransactionT, stripUrlQueryAndFragment as stripUrlQueryAndFragmentT, Transaction as TransactionT } from '@sentry-internal/tracing';
/**
